...
[![Release](https://img.shields.io/badge/release-v0.1.22-C2410C?style=for-the-badge)](https://github.com/Yabuku-xD/contextforge/releases)
...
- Eagerly reads and indexes the whole repository at startup, then keeps the index fresh with targeted syncs as files change
...
- Seeds Claude project installs with a pre-allowed ContextForge toolset to reduce repeat permission prompts
