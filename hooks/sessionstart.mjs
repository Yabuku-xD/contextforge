...
<contextforge_routing>
  ...
  Tool preference:
  - forge_start: warm up ContextForge for non-trivial repo tasks and eagerly read/index the whole repository at session start
