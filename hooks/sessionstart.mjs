...
<contextforge_routing>
  ...
  - forge_walk: use for exhaustive whole-project prompts like "every file, folder, and subfolder", "walk the repo", or "go through each package/module". For explicit all-files requests it performs a local file-body audit and returns a compact repo digest before manual reads
